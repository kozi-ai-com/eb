    ...
    <section id="domains" className="py-28 sm:py-36 px-6">
      <div className="max-w-[1120px] mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {items.map((item, i) => (
            <BlurFade key={i} delay={0.1 + i * 0.08} className={item.wide ? 'sm:col-span-2' : ''}>
              <MagneticCard className="h-full">
                <div className={`group relative h-full p-6 rounded-2xl border transition-all duration-300 overflow-hidden ${
                  ...
                  <div className={`w-9 h-9 rounded-lg flex items-center justify-center mb-4 ${
                    ...
                    <item.icon size={17} className="text-kozi-blue" />
                  </div>
